package com.greeny.ecomate.utils.jwt;
...
public class JWTUtil {
    ...
    private Algorithm getSigninKey(String secretKey) {
    ...
    public String getNameFromToken(String token) {
        ...
        return verifiedToken.getClaim("name").asString();
    }

    private JWTVerifier getTokenValidator() {
        return JWT.require(getSigninKey(SECRET_KEY))
                .withIssuer(ISSUER)
                .build();
    }
